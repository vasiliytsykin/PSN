                    ...
                    <div class="info-block__content">
                        <div class="info-block__txt-over">
                            <div class="info-block__txt">
                                ...
                                <h5>С 5 октября по 1 января</h5>
                                <p>
                                    100 тысяч рублей в подарок! Позволь себе больше с сертификатом по акции «Феноменальная выгода»!
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="info-block__content">
                        <div class="info-block__txt-over">
                            <div class="info-block__txt">
                                ...
                                <h5>С 10 октября</h5>
                                <p>
                                    Все семьи с двумя и более детьми, покупая квартиру,
                                    могут рассчитывать на снижение ее стоимости эквивалентной сумме субсидии от государства.
                                </p>
                            </div>
                        </div>
