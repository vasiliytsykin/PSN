var patternizer = (function () {
    ...
    function Patternizer(){
        ...
        this.patterns = {
            ...
            'bird': {
                name: 'bird',
                svg: '<svg id="bird" class="pattern-svg" width="140" height="170" viewBox="-929 916 140 170"><line class="st1" x1="-870" y1="1021.1" x2="-870" y2="1002"/><line class="st1" x1="-853.7" y1="1021.1" x2="-853.7" y2="1002"/><path class="st1" d="M-815.6 954.2h-19.3c-0.3-0.4-0.5-0.8-0.8-1.2-3.4-4.5-8-8.1-13.3-10.2l-6.6 9.4-35.3 49.8 0 0h30.7c15.6 0 28.5-11.7 30.4-26.8L-815.6 954.2z"/><path class="st1" d="M-850 962.2L-850 962.3z"/><circle class="st1" cx="-882.2" cy="1048.7" r="10.4"/><circle class="st1" cx="-835.8" cy="1048.7" r="10.4"/><line class="st1" x1="-812.8" y1="1038.3" x2="-905.2" y2="1038.3"/></svg>',
                animation: {
                    speed: 'fast',
                    repeat: false
                }
            ...
            'flower': {
                name: 'flower',
                svg: '<svg id="flower" class="pattern-svg" width="200" height="200" viewBox="1544 -89.9 200 200"><path class="st1" d="M1644-26.2c-5.6 0-8.6 2.4-8.6 8.9 0 8.4 4.9 20.4 8.6 20.4 4.3 0 8.6-12 8.6-20.4C1652.6-23.7 1649.6-26.2 1644-26.2z"/><path class="st1" d="M1644 46.3c5.6 0 8.6-2.4 8.6-8.9 0-8.4-4.9-20.4-8.6-20.4-4.3 0-8.6 12-8.6 20.4C1635.4 44 1638.4 46.3 1644 46.3z"/><path class="st1" d="M1680.3 10.2c0-5.6-2.4-8.6-8.9-8.6-8.4 0-20.4 4.9-20.4 8.6 0 4.3 12 8.6 20.4 8.6C1677.9 18.7 1680.3 15.8 1680.3 10.2z"/><path class="st1" d="M1607.7 10.2c0 5.6 2.4 8.6 8.9 8.6 8.4 0 20.4-4.9 20.4-8.6 0-4.3-12-8.6-20.4-8.6C1610.1 1.6 1607.7 4.5 1607.7 10.2z"/></svg>',
                animation: {
                    speed: 'fast',
                    repeat: false
                }
