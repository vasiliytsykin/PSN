...
var patt = [
    ...
    ['<svg version="1.1" id="Layer_2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"',
        ...
        '   <g id="XMLID_335_">',
        '      <g id="XMLID_336_">',
        '         <line id="XMLID_340_" class="stY" x1="53.3" y1="33.7" x2="53.3" y2="33.7"/>',
        '         <line id="XMLID_339_" class="stY" x1="33.3" y1="89.1" x2="33.3" y2="70"/>',
        '         <line id="XMLID_338_" class="stY" x1="49.6" y1="89.1" x2="49.6" y2="70"/>',
        '         <path id="XMLID_337_" class="stY" d="M87.7,22.2H68.3c-0.3-0.4-0.5-0.8-0.8-1.2c-3.4-4.5-8-8.1-13.3-10.2l-6.6,9.4L12.3,70v0H43',
    ...
    ['<svg version="1.1" id="Layer_3" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"',
        ...
        '   .st0{fill:none;stroke:#FFDC3E;stroke-width:7;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;}',
        '</style>',
        '<path id="XMLID_1711_" class="st0 yellow" d="M-49,142.7c5.1,0,10.1-14.2,10.1-24c0-7.6-3.5-10.5-10.1-10.5s-10.1,2.8-10.1,10.5C-59.1,128.6-53.3,142.7-49,142.7"/>',
        '<path id="XMLID_1710_" class="st0 yellow" d="M-49,159.3c-5.1,0-10.1,14.2-10.1,24c0,7.6,3.5,10.5,10.1,10.5s10.1-2.8,10.1-10.5C-38.9,173.4-44.7,159.3-49,159.3"/>',
        '<path id="XMLID_1708_" class="st0 yellow" d="M-40.7,151c0,5.1,14.2,10.1,24,10.1c7.6,0,10.5-3.5,10.5-10.1s-2.8-10.1-10.5-10.1C-26.6,140.9-40.7,146.7-40.7,151"/>',
        '<path id="XMLID_1707_" class="st0 yellow" d="M-57.3,151c0-5.1-14.2-10.1-24-10.1c-7.6,0-10.5,3.5-10.5,10.1s2.8,10.1,10.5,10.1C-71.4,161.1-57.3,155.3-57.3,151"/>',
        '</g>',
        '</svg>'
    ].join(''),
    ['<svg version="1.1" id="Layer_4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"',
        ...
        '</style>',
        '<g id="XMLID_379_">',
        '<path xmlns="http://www.w3.org/2000/svg" id="XMLID_1713_" class="st0 yellow" d="M91,27.2 71.2,47.1 50.5,26.4 29.7,47.1 9,26.4 "/> <path xmlns="http://www.w3.org/2000/svg" id="XMLID_1712_" class="st0 yellow" d="M91,53.8 71.2,73.6 50.5,52.9 29.7,73.6 9,52.9 "/>',
        '</g>',
        '</svg>'
    ].join(''),
    ['<svg version="1.1" id="Layer_5" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"',
        '    viewBox="0 0 100 100" style="enable-background:new 0 0 100 100;" xml:space="preserve">',
        '<style type="text/css">',
        '   .stY{fill:none;stroke:#FFDC3E;stroke-width:7;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;}',
        '</style>',
        '<polyline id="XMLID_1716_" class="stY" points="14.9,26.6 61.7,73.4 85.1,50 61.7,26.6 14.9,73.4 "/>',
        '</svg>'
    ].join('')
...
$(function () {
    ...
    $(window).on('resize', function () {
        ...
        var benefits = $('.main-page .benefits');
        var verticalBlocks = $('.main-page .benefits .info-block--vert');
